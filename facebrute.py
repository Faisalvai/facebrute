...
Usage: python ./facebrute.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
...
Examples:
        |
     |--------
     | python facebrute.py -t Victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python facebrute.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python facebrute.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python facebrute.py -t Victim@gmail.com -s 1234567
     |--------
     | python facebrute.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
